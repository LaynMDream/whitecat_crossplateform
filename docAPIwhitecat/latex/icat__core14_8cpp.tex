...
Fonctions core pour i\-Cat qui permet de controller whitecat sur un iphone via le logiciel ifantastic Core fonctions for icat a iphone control and gui send via the i\-Fantastic software 
