...
\begin{DoxyCompactList}\small\item\em le volatile int dans arduino car possibilit� de changer le rate d appel de la fonction read \end{DoxyCompactList}\item 
int \hyperlink{arduino__core__6___u_n_o_8cpp_a2e0d87a66de28332b21590d0cecc6235}{old\-\_\-ticks\-\_\-arduino} =0
\end{DoxyCompactItemize}


\subsection{Description détaillée}
\{arduino fonctions\} \begin{DoxyAuthor}{Auteur}
