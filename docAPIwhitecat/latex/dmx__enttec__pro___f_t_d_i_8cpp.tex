\hypertarget{dmx__enttec__pro___f_t_d_i_8cpp}{\section{dmx\-\_\-enttec\-\_\-pro\-\_\-\-F\-T\-D\-I.\-cpp File Reference}
...
\{send dmx fonctions to the enttec usb pro via the fdtdi D2xx drivers\} \begin{DoxyAuthor}{Author}
...
Gère les envoie de config du port V\-C\-O\-M et autre fonction pour l'enttec usb pro, specifique pour windows Config the V\-C\-O\-M port and other fonctions for the enttec usb pro, only for windows 
