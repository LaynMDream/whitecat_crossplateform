...
Fonctions pour déssiner la fenêtre i\-Cat qui permet de controller whitecat sur un iphone via le logiciel ifantastic G\-U\-I fonctions for icat a iphone control and gui send via the i\-Fantastic software 
