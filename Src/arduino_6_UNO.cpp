...
//Arduino config
    ...
    if(index_do_light_send_config>0)
    {
        index_do_light_send_config-=0.2;
        if(index_do_light_send_config<0) index_do_light_send_config=0;
    }
    ...
    if(mouse_y>cfg_Y+3 && mouse_y<cfg_Y+27)
    {
        ...
        else if(mouse_x>cfg_X+428 && mouse_x<cfg_X+452)
        {
            ...
            if(mouseClicLeft.isDown())
            {
                ...
                if(position_line_io<=arduino_max_digital-11)
                {
                    position_line_io++;
                }
            }
