...
*   Fonctions pour déssiner la fenêtre iCat qui permet de controller whitecat sur un iphone via le logiciel ifantastic
*
*   GUI fonctions for icat a iphone control and gui send via the iFantastic software
*
 **/
...
///////////////SLIDER EDITING///////////////////////////////////////////////////
    ...
    if(mouse_x>xed-15 && mouse_x<xed+90 && mouse_y>yed-10 && mouse_y<yed+10
            && mouseClicLeft.isDown() && mouseClicLeft.isToBeProcessed() && window_focus_id==W_iCAT)
    {
...
//NAVIGATION DANS LE SLIDER A EDITER
    ...
    {
        if(mouse_x>xed-15 && mouse_x<xed+5 && mouseClicLeft.isDown() && mouseClicLeft.isToBeProcessed() && window_focus_id==W_iCAT)
        {
        ...
        if(mouse_x>xed+50 && mouse_x<xed+70 && mouseClicLeft.isDown() && mouseClicLeft.isToBeProcessed() && window_focus_id==W_iCAT)
        {
            editing_GUI_type_iCat=1;
...
//DEF MAX SLIDERS
    ...
    {
        if(mouse_y>yed+15 && mouse_y<yed+30 && mouseClicLeft.isDown() && mouseClicLeft.isToBeProcessed() && window_focus_id==W_iCAT )
        {
            editing_GUI_type_iCat=1;
        ...
        if(mouse_y>yed+35 && mouse_y<yed+50 && mouseClicLeft.isDown() && mouseClicLeft.isToBeProcessed() && window_focus_id==W_iCAT )
        {
            editing_GUI_type_iCat=1;
...
//grossuer slider
    ...
    if(mouse_x>xed-12 && mouse_x<xed+18 && mouse_y>yed+55 && mouse_y<yed+75 &&
            mouseClicLeft.isDown() && mouseClicLeft.isToBeProcessed() && window_focus_id==W_iCAT  && iCat_select_editing_slider!=0)
    {
        editing_GUI_type_iCat=1;
...
//VARIABLE A LA SOURIS
    ...
    if(mouse_x>xed+40 && mouse_x<xed+85 && mouse_y>yed+120 && mouse_y<yed+140 &&  window_focus_id==W_iCAT )
    {
        ...
        if(  mouseClicLeft.isDown() && mouseClicLeft.isToBeProcessed() && iCat_select_editing_slider!=0)
        {
            editing_GUI_type_iCat=1;
...
//NAVIGATION DANS LE bouton A EDITER
    ...
    if(mouse_y>yed+15 && mouse_y< yed+35)
    {
        ...
        if(mouse_x>xed+50 && mouse_x<xed+70 && mouseClicLeft.isDown() && mouseClicLeft.isToBeProcessed() && window_focus_id==W_iCAT)
        {
            editing_GUI_type_iCat=2;
            next_button_view(xed+50,yed+15,1);
            if(iCat_select_editing_button<iCat_nbre_de_boutons[iCatPageis])
            {
                iCat_select_editing_button++;
            }
            else
...
//grossuer bouton
    ...
    pulse_bar_view(xed-12,yed+55, str_type_iCat);
    if(mouse_x>xed-12 && mouse_x<xed+18 && mouse_y>yed+55 && mouse_y<yed+75 &&
            mouseClicLeft.isDown() && mouseClicLeft.isToBeProcessed() && window_focus_id==W_iCAT && iCat_select_editing_button!=0)
    {
        editing_GUI_type_iCat=2;
        ratio_iCat_button[iCatPageis][iCat_select_editing_button]++;
        if(ratio_iCat_button[iCatPageis][iCat_select_editing_button]>3)
        {
            ratio_iCat_button[iCatPageis][iCat_select_editing_button]=1;
        }
        mouseClicLeft.SetProcessed();
    }
...
//TYPE
            ...
            mouseClicLeft.isDown() && mouseClicLeft.isToBeProcessed() && window_focus_id==W_iCAT && iCat_select_editing_button!=0)
    {
        ...
        if(iCat_affectation_bouton_type_is[iCatPageis][iCat_select_editing_button]>7)
        {
            iCat_affectation_bouton_type_is[iCatPageis][iCat_select_editing_button]=0;
        }
...
//sous famille
            ...
            mouseClicLeft.isDown() && mouseClicLeft.isToBeProcessed() && window_focus_id==W_iCAT  && iCat_select_editing_button!=0)
    {
        ...
        if(iCat_affectation_bouton_action_is[iCatPageis][iCat_select_editing_button]>max_menu)
        {
            iCat_affectation_bouton_action_is[iCatPageis][iCat_select_editing_button]=0;
        }
        mouseClicLeft.SetProcessed();
...
//VARIABLE A LA SOURIS
    ...
    if(mouse_x>xed+40 && mouse_x<xed+85 && mouse_y>yed+150 && mouse_y<yed+170 &&  window_focus_id==W_iCAT )
    {
        editing_GUI_type_iCat=2;
        AffectVar.DrawOutline(CouleurLigne);
        if(  mouseClicLeft.isDown() && mouseClicLeft.isToBeProcessed() && iCat_select_editing_button!=0)
        {
...
//grossuer bouton
    ...
    pulse_bar_view(xed-12,yed+55, str_type_iCat);
    if(mouse_x>xed-12 && mouse_x<xed+18 && mouse_y>yed+55 && mouse_y<yed+75 &&
            mouseClicLeft.isDown() && mouseClicLeft.isToBeProcessed() && window_focus_id==W_iCAT  && iCat_select_editing_string!=0)
    {
        editing_GUI_type_iCat=3;
...
//VARIABLE A LA SOURIS
    if(iCat_affectation_string_type_is[iCatPageis][iCat_select_editing_string]==2 )
    {
        ...
        if(mouse_x>xed+40 && mouse_x<xed+40+45 && mouse_y>yed+150 && mouse_y<yed+150+20 &&  window_focus_id==W_iCAT )
        {
            editing_GUI_type_iCat=3;
            AffectVar.DrawOutline(CouleurLigne);
            if(  mouseClicLeft.isDown() && mouseClicLeft.isToBeProcessed() && iCat_select_editing_string!=0)
            {
                int temp_number=atoi(numeric);
                reset_numeric_entry();
                switch(iCat_affectation_string_type_is[iCatPageis][iCat_select_editing_string])
...
//vertical
            ...
            {
                l_sl=iCatSlidersizeX;
                h_sl=iCatSlidersizeY;
            }
            //horizontal
            else
            {
                l_sl=iCatSlidersizeY;
                h_sl=iCatSlidersizeX;
            }
//affichage si dans tablier
            if(iCat_pos_slider[iCatPageis][sl][0]<L_tablier_iCat &&  iCat_pos_slider[iCatPageis][sl][1]<H_tablier_iCat)
            {
                ...
                if(slider_is_touched[iCatPageis][sl]==1)
                {
                    Slider_Big.Draw(CouleurFader);
                }
...
//affichage boutons que si dans tablier
            if(iCat_pos_bouton[iCatPageis][sl][0]<L_tablier_iCat &&  iCat_pos_bouton[iCatPageis][sl][1]<H_tablier_iCat)
            {
                ...
                if(button_is_touched[iCatPageis][sl]==1)
                {
                    Bouton_Big.Draw(CouleurFader);
                }
...
//DEF MAX BOUTONS
    ...
    if(mouse_x>xed+75 && mouse_x<xed+90)
    {
        if(mouse_y>yed+15 && mouse_y<yed+30 && mouseClicLeft.isDown() && mouseClicLeft.isToBeProcessed() && window_focus_id==W_iCAT && editing_GUI_type_iCat==4)
        {
            case_moins_view(xed+75,yed+15,1);
            if(iCat_nbre_de_tracking_zone[iCatPageis]>0)
            {
        ...
        if(mouse_y>yed+35 && mouse_y<yed+50 && mouseClicLeft.isDown() && mouseClicLeft.isToBeProcessed() && window_focus_id==W_iCAT && editing_GUI_type_iCat==4)
        {
            case_plus_view(xed+75,yed+35,1);
...
//grossuer zone
    ...
    pulse_bar_view(xed-12,yed+55, str_type_iCat);
    if(mouse_x>xed-12 && mouse_x<xed+18 && mouse_y>yed+55 && mouse_y<yed+75 &&
            mouseClicLeft.isDown() && mouseClicLeft.isToBeProcessed() && window_focus_id==W_iCAT && editing_GUI_type_iCat==4 && iCat_select_tracking_zone!=0)
    {
...
//X
    ...
    {
        AffectVar.DrawOutline(CouleurLigne);
        if(  mouseClicLeft.isDown() && mouseClicLeft.isToBeProcessed() && iCat_select_tracking_zone!=0)
        {
            int temp_number=atoi(numeric);
...
int BoxiCat ( int macx, int macy)
{
    ...
    if(window_focus_id==W_CFGMENU && mouse_x>macx+75 && mouse_x<macx+125  && mouse_y>macy+75 && mouse_y<macy+100)
    {
        ...
        if(mouseClicLeft.isDown() && mouseClicLeft.isToBeProcessed())
        {
            ...
            if(nbre_d_envois_de_l_info<1)
            {
                nbre_d_envois_de_l_info=1;
            }
            reset_numeric_entry();
            mouseClicLeft.SetProcessed();
        }
...
//direct chan
                ...
                if(midi_send_out[(iCat_affectation_slider_value_is[iCatPageis][sl]-1)]==1)
                {
                    index_send_midi_out[(iCat_affectation_slider_value_is[iCatPageis][sl]-1)]=1;
                }
            ...
            case 3://sequenciel 0: stage 1: preset 2: accelerometre
                ...
                case 2:
                    ...
                    prepare_crossfade();
                    if(crossfade_speed<0)
                    {
                        crossfade_speed=0;
                    }
                    if(crossfade_speed>127)
                    {
                        crossfade_speed=127;
                    }
            ...
            case 6://MOVER
                ...
                if(midi_send_out[1700+(iCat_affectation_slider_value_is[iCatPageis][sl]-1)]==1)
                {
                    index_send_midi_out[1700+(iCat_affectation_slider_value_is[iCatPageis][sl]-1)]=1;
                }
                break;
            ...
            case 9: //DRAW GHOST
                ...
                if((iCat_affectation_slider_value_is[iCatPageis][sl]-1)==draw_preset_selected)
                {
                    ...
                    if(midi_send_out[1656]==1)
                    {
                        index_send_midi_out[1656]=1;
                    }
                }
                break;
