...
//points
    ...
    curve_ctrl_pt[curve][2][0]=27;
    curve_ctrl_pt[curve][2][1]=255-89;//point 1 en 0 0
    curve_ctrl_pt[curve][3][0]=55;
    curve_ctrl_pt[curve][3][1]=255-153;//point 1 en 0 0
    curve_ctrl_pt[curve][4][0]=118;
    curve_ctrl_pt[curve][4][1]=255-213;//point 1 en 0 0
...
//points
    ...
    curve_ctrl_pt[curve][2][0]=12;
    curve_ctrl_pt[curve][2][1]=255-45;//point 1 en 0 0
    curve_ctrl_pt[curve][3][0]=45;
    curve_ctrl_pt[curve][3][1]=255-103;//point 1 en 0 0
    curve_ctrl_pt[curve][4][0]=157;
    curve_ctrl_pt[curve][4][1]=255-178;//point 1 en 0 0
