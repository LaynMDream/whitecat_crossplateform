...
*
*   GUI fonctions for the wizard window, a tool to change parameter easly in all memories or group of memories
*
**/
...
//from
            if( mouse_y>yb+200 && mouse_y<yb+230)
            {
                ...
                if(mouseClicLeft.isDown() && mouseClicLeft.isToBeProcessed())
                {
                    ...
                    {
                        sprintf(string_Last_Order,">>Wrong entry : a Mem is from 0.0 to 999.9!");
                    }
    ...
    if(window_focus_id==W_WIZARD && mouse_x>xb+438 && mouse_x<xb+462)
    {
        if(mouse_y>yb+278 && mouse_y<yb+302)
        {
            ...
            if(mouseClicLeft.isDown())
            {
                ...
                if(position_ligne_wizard_out>0)
                {
                    position_ligne_wizard_out--;
                }
            }
        }
        else if(mouse_y>yb+338 && mouse_y<yb+362)
        {
            ...
            if(mouseClicLeft.isDown())
            {
                ...
                if(position_ligne_wizard_out<36)
                {
                    position_ligne_wizard_out++;
                }
            }
...
///////MEM TO MEM////////////////////////////////////////////////////////////
        ...
        for (int li=0; li<7; li++)
        {
            ...
            if(wizard_action_mem==li)
            {
                domact.Draw(CouleurFader);
            }
...
////LES OPTIONS
        ...
        case 0://REBUILD
            ...
            for(int mod=0; mod<3; mod++)
            {
                ...
                if(mod==mode_rebuild)
                {
                    choose_mode_rebuild.DrawOutline(CouleurLevel);
                }
        ...
        if(window_focus_id==W_WIZARD && mouse_x>xb+438 && mouse_x<xb+462)
        {
            if(mouse_y>yb+48 && mouse_y<yb+72)
            {
                ...
                if(mouseClicLeft.isDown())
                {
                    ...
                    if(position_ligne_wizard_in>0)
                    {
                        position_ligne_wizard_in--;
                    }
                }
            }
            else if(mouse_y>yb+108 && mouse_y<yb+132)
            {
                ...
                if(mouseClicLeft.isDown())
                {
                    ...
                    if(position_ligne_wizard_in<36)
                    {
                        position_ligne_wizard_in++;
                    }
                }
