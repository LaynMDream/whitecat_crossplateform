...
int do_logical_my_window_Box(int mx, int my)
{
    ...
    if(window_focus_id==W_MY_WINDOW && mouseClicLeft.isToBeProcessed())//si focus sur la fenetre my window et que bouton pas enclenché
    {
//BOUTON LOOP
...
FaderLevel.Draw(CouleurFader);
FaderFrame.DrawOutline(CouleurLigne);
if(window_focus_id==W_MY_WINDOW && mouseClicLeft.isDown())//mouse_button n est pas utilisé dans le code scindé,
