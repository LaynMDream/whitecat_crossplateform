...
* \brief {fonctions for the sunlite dmx interfaces}
...
//open device
    ...
    if( iReto>0)
    {
        sprintf(string_display_dmx_params,"Init Sunlite DLL version %d=Ok", iReto);
    }
    ...
    else if (sunlite_serial_number>562173952 && sunlite_serial_number<562173952+100000)
    {
        sprintf(string_sunlite_is,"SIDUI-5C interface");
    }
    else  if (sunlite_serial_number>61865984 && sunlite_serial_number<61865984+100000)
    {
        sprintf(string_sunlite_is,"SIDUI-6C interface");
    }
