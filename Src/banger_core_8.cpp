    ...
    case 1: //fader
        ...
        if(the_fader_is>=0 && the_fader_is<core_user_define_nb_faders)
        {
            ...
            case 11://set Fader At
                ...
                if(DockTypeIs[the_fader_is][dock_used_by_fader_is[the_fader_is]]==10)
                {
            ...
            case 12://end pos pour auto mouvement
                ...
                {
                    StopPosOn[the_fader_is]=1;
                    LevelStopPos[the_fader_is]=lStopP;
                    do_light_setpos[the_fader_is]=1;
            ...
            case 26://load chaser in activ dock
                ...
                {
                    sprintf(string_event,"LoadChaser in Fader >> Invalid entry");
                }
                break;
            case 27://play chaser in activ dock
                if( param2_is==0 || param2_is==1)
                {
                    if(DockTypeIs[the_fader_is][(dock_used_by_fader_is[the_fader_is])]==11)
                    {
                        ...
                        case 1:
                            ...
                            if(chaser_step_is[ChaserAffectedToDck[the_fader_is][(dock_used_by_fader_is[param1_is])]]<0)
                            {
                                chaser_step_is[ChaserAffectedToDck[the_fader_is][(dock_used_by_fader_is[param1_is])]]=0;
                            }
                            else if(chaser_step_is[ChaserAffectedToDck[the_fader_is][(dock_used_by_fader_is[param1_is])]]>35)
                            {
                                chaser_step_is[ChaserAffectedToDck[the_fader_is][(dock_used_by_fader_is[param1_is])]]=35;
                            }
                    ...
                    {
                        sprintf(string_event,"No Chaser loaded in Fader %d Dock %d ", the_fader_is+1,dock_used_by_fader_is[param1_is]+1);
                    }
                }
                else
                {
            ...
            case 29://loop chaserin activ dock
                ...
                {
                    sprintf(string_event,"LOOP Chaser entry must be 0 or 1");
                }
                break;
...
//send_my_midi_note( int letype,  int lechannel, int lanote, int lavelocite, int laduree)
            ...
            case 22://midi out sur faders chasers
                if(param2_is==0)
                {
                    ...
                    refresh_midi_chasers=0;
                    set_refresh_mode_for_chaser(0);
                    sprintf(string_event,"Midi Out Chasers Tracks OFF");
                }
                else
                {
                    refresh_midi_chasers=1;
                    set_refresh_mode_for_chaser(1);
                    for (int p=1023; p<1047; p++)
                    {
...
////////////DEBUT WINDOWS//////////////////////////////////////////////////////////
    case 3:
        ...
        case 2://faders
            ...
            if(param1_is>0 && param1_is<7)
            {
                scroll_faderspace=15;
            }
            else if(param1_is>6 && param1_is<13)
            {
                scroll_faderspace=127;
            }
            else if(param1_is>12 && param1_is<19)
            {
                scroll_faderspace=236;
            }
            else if(param1_is>18 && param1_is<25)
            {
                scroll_faderspace=345;
            }
            else if(param1_is>24 && param1_is<31)
            {
                scroll_faderspace=454;
            }
            else if(param1_is>30 && param1_is<37)
            {
                scroll_faderspace=563;
            }
            else if(param1_is>36 && param1_is<43)
            {
                scroll_faderspace=672;
            }
            else if(param1_is>42 && param1_is<49)
            {
                scroll_faderspace=782;
            }
        ...
        if(param1_is>=0 && param1_is<5)
        {
            ...
            case 0://clear player
                if(player_ignited[param1_is]==1)
                {
                    ...
                    if(midi_send_out[624+param1_is]==1)
                    {
                        index_send_midi_out[624+param1_is]=1;   //pitch
                    }
            ...
            case 2://play pause
                ...
                case 0:
                    ...
                    case 0:
                        ...
                        {
                            player1_do_stop();
                            sprintf(string_event,"Player 1 STOP");
                        }
                        break;
                    case 1:
                        if(player_ignited[param1_is]==1)
                        {
                            player1->play();
                            sprintf(string_event,"Player 1 PLAY");
                        }
                        break;
                    }
                    break;
                case 1:
                    ...
                    case 0:
                        ...
                        {
                            player2_do_stop();
                            sprintf(string_event,"Player 2 STOP");
                        }
                        break;
                    case 1:
                        if(player_ignited[param1_is]==1)
                        {
                            player2->play();
                            sprintf(string_event,"Player 2 PLAY");
                        }
                        break;
                    }
                    break;
                case 2:
                    ...
                    case 0:
                        ...
                        {
                            player3_do_stop();
                            sprintf(string_event,"Player 3 STOP");
                        }
                        break;
                    case 1:
                        if(player_ignited[param1_is]==1)
                        {
                            player3->play();
                            sprintf(string_event,"Player 3 PLAY");
                        }
                        break;
                    }
                    break;
                case 3:
                    ...
                    case 0:
                        ...
                        {
                            player4_do_stop();
                            sprintf(string_event,"Player 4 STOP");
                        }
                        break;
                    case 1:
                        if(player_ignited[param1_is]==1)
                        {
                            player4->play();
                            sprintf(string_event,"Player 4 PLAY");
                        }
                        break;
                    }
                    break;
            ...
            case 5:
                ...
                case 0:
                    if(player_ignited[param1_is]==1)
                    {
                        ...
                        sprintf(string_event,"Player 1 SeekToZero");
                    }
                    break;
                case 1:
                    if(player_ignited[param1_is]==1)
                    {
                        ...
                        sprintf(string_event,"Player 2 SeekToZero");
                    }
                    break;
                case 2:
                    if(player_ignited[param1_is]==1)
                    {
                        ...
                        sprintf(string_event,"Player 3 SeekToZero");
                    }
                    break;
                case 3:
                    if(player_ignited[param1_is]==1)
                    {
                        ...
                        sprintf(string_event,"Player 4 SeekToZero");
                    }
                    break;
                }
...
//SEQUENCES/////////////////////////////////////////////////////////////////////
    ...
    case 6:
        ...
        case 0:  //ontsage mem
            ...
            {
                sprintf(string_event,"mem %d.%d doesn't exist !",position_onstage/10,position_onstage%10);
            }
            break;
        case 1: //preset mem
            if(MemoiresExistantes[memoire_asked_in_bang]==1)
            ...
            {
                sprintf(string_event,"Mem %d.%d doesn't exist !",position_preset/10,position_preset%10);
            }
            break;
        case 2://set speed at
            if(param1_is>=0 && param1_is<128)
        ...
        case 1://play chaser
            if(param1_is>0 && param1_is<core_user_define_nb_chasers && (param2_is==0 || param2_is==1))
            {
                ...
                case 1:
                    ...
                    //bug olivier marche arriere arrière ligne
                    if(chaser_step_is[param1_is-1]<0)
                    {
                        chaser_step_is[param1_is-1]=0;
                    }
                    else if(chaser_step_is[param1_is-1]>35)
                    {
                        chaser_step_is[param1_is-1]=35;
                    }
                    break;
                }
            }
        ...
        if(param1_is>=0 && param1_is<core_user_define_nb_faders && param2_is>=0 && param2_is<=1 )
        {
            ...
            case 1://"Select All"
                if(param2_is==0)
                {
                    ...
                    sprintf(string_event,"Unselected ALL Minifaders");
                }
                else if(param2_is==1)
                {
                    for(int i=0; i<core_user_define_nb_faders; i++)
                    ...
                    sprintf(string_event,"Selected ALL Minifaders");
                }
                break;
        ...
        case 8://"Play/Pause");   //Player ON/OFF
            if(param1_is>0 && param1_is<5)
            {
                ...
                if(param2_is==0 || param2_is ==1)
                {
                    ...
                    {
                        sprintf(string_event,"Stop GridPl %d",numgridpl+1);
                    }
                }
            }
            break;
        ...
        case 10://"Autostop");
            if(param1_is>0 && param1_is<5)
            {
                ...
                if(param2_is==0 || param2_is ==1)
                {
                    ...
                    if(param2_is==1)
                    {
                        sprintf(string_event,"GridPl %d Autostop /On",numgridpl+1);
                    }
                    else
                    {
                        sprintf(string_event,"GridPl %d Autostop /Off",numgridpl+1);
                    }
                }
            }
            break;
        case 11://,"Macro Goto");
            if(param1_is>0 && param1_is<5)
            {
                ...
                if(param2_is==0 || param2_is ==1)
                {
                    ...
                    if(param2_is==1)
                    {
                        sprintf(string_event,"GridPl %d MacroGoto /On",numgridpl+1);
                    }
                    else
                    {
                        sprintf(string_event,"GridPl %d MacroGoto /Off",numgridpl+1);
                    }
                }
            }
            break;
        case 12://"Macro Seek");
            if(param1_is>0 && param1_is<5)
            {
                ...
                if(param2_is==0 || param2_is ==1)
                {
                    ...
                    if(param2_is==1)
                    {
                        sprintf(string_event,"GridPl %d MacroSeek /On",numgridpl+1);
                    }
                    else
                    {
                        sprintf(string_event,"GridPl %d MacroSeek /Off",numgridpl+1);
                    }
                }
            }
            break;
        case 13://"Macro StopPlay");
            if(param1_is>0 && param1_is<5)
            {
                ...
                if(param2_is==0 || param2_is ==1)
                {
                    ...
                    if(param2_is==1)
                    {
                        sprintf(string_event,"GridPl %d MacroStopPlay /On",numgridpl+1);
                    }
                    else
                    {
                        sprintf(string_event,"GridPl %d MacroStopPlay /Off",numgridpl+1);
                    }
                }
            }
            break;
        ...
        case 16://"Slave Mode");
            if(param1_is>0 && param1_is<5)
            {
                ...
                if(param2_is==0 || param2_is ==1)
                {
                    ...
                    if(param2_is==1)
                    {
                        sprintf(string_event,"GridPl %d Slave /On",numgridpl+1);
                    }
                    else
                    {
                        sprintf(string_event,"GridPl %d Slave /Off",numgridpl+1);
                    }
                }
            }
            break;
    ...
    case 17://DRAW
        ...
        if(param1_is>=0 && param1_is<=6)
        {
            ...
            case 1://"Set Brush");
                ...
                if (draw_brush_type[param1_is]>1)
                {
                    draw_brush_type[param1_is]=1;
                }
                sprintf(string_event,"DrawBrush %d on Matrix %d",param2_is, param1_is+1);
                break;
            case 2://"Set DrawMode");
                draw_mode[param1_is]=param2_is;
                if (draw_mode[param1_is]>3)
                {
                    draw_mode[param1_is]=3;
                }
    ...
    case 18://ECHO
        ...
        case 13://"S.SetChanPos");
            if(param2_is>0 && param2_is<513 )
            {
                ...
                if(param2_is-1>(511-14))
                {
                    echo_grid_channel_position[param1_is-1]=511-14;
                }
