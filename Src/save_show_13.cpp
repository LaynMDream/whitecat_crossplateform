...
int load_gel_list_numerical()
{
    ...
    {
        sprintf(string_save_load_report[0],"Error opening %s","gel_list_num_order.txt");
        b_report_error[0]=1;
        idf++;
    }
    else
    {
        do
        {
            if (fgets(line,256,f)!=NULL)
            {
                ...
                if(strcmp(tmp_name_of_mark,"Lee")==0)
                {
                    index_type_of_gel=0;
                }
                if(strcmp(tmp_name_of_mark,"Rosco")==0)
                {
                    index_type_of_gel=1;
                }
                if(strcmp(tmp_name_of_mark,"GamColor")==0)
                {
                    index_type_of_gel=2;
                }
                if(strcmp(tmp_name_of_mark,"Apollo")==0)
                {
                    index_type_of_gel=3;
                }
...
int Save_Core_Config()
{
    ...
    if((fpp=fopen("user/config_core.txt","w")))//etait wb
    {
        ...
        fprintf(fpp, "%d / %d /\n",BPS_RATE,dmxINrate);
        fclose(fpp);
        sprintf(string_save_load_report[idf],"Saved config_core.txt");
...
int Save_onstart_Config()
{
    ...
    if((fpp=fopen("user/config_onstart.txt","w")))//etait wb
    {
        ...
        fprintf(fpp, "%d / %d / %d / %d /\n" ,  load_camera_on_start, open_arduino_on_open , enable_iCat, expert_mode);
        fclose(fpp);
        sprintf(string_save_load_report[idf],"Saved config_onstart.txt");
    }
...
int Save_Screen_Config()
{
    ...
    if((fpp=fopen("user/config_screens.txt","w")))//etait wb
    {
        ...
        fclose(fpp);
        sprintf(string_save_load_report[idf],"Saved config_screen.txt");
    }
...
int Save_Plot_Plan_config()
{
    ...
    if((fpp=fopen("plot_plan_config.txt","w")))//etait wb
    {
        ...
        fprintf(fpp, "%d / %d / %d / %d / %d / %f / %f / %d / %d / %d / %f / %f / %f / %d /\n",plot_quadrillage_size,plot_window_width,plot_window_height, plot_view_port_x, plot_view_port_y, Color_plotline, Color_plotfill, nbre_shapes_on_plot, index_show_shape_id, plot_grid_type,alpha_grille, general_alpha_for_shape, ratio_lock_plot_scale, mode_relatif_xy_solo);
        fclose(fpp);
...
int Load_Plot_Plan_config()
{
    ...
    if( !cfg_file )
    {
        sprintf(string_save_load_report[idf],"Error on opening plot_plan_config.txt");
        b_report_error[idf]=1;
    }
    else
    {
...
//premiere ligne les args
        if( !fgets( read_buff_winfil , sizeof( read_buff_winfil ) ,cfg_file ) )
        {
            sprintf(string_save_load_report[idf],"Error on reading plot_plan_config.txt");
            b_report_error[idf]=1;
        }
        else
        {
            sprintf(string_save_load_report[idf],"plot_plan_config.txt readed");
        }
//2eme ligne
        fscanf( cfg_file , "%s\n" , Name_of_plane_is);
//args
...
//6eme
    ...
    else if(plot_quadrillage_size>100)
    {
        plot_quadrillage_size=100;
    }
...
int Save_Audio_Conf()
{
    ...
    {
        sprintf(string_save_load_report[idf],"Error on audio_conf.txt");
        b_report_error[idf]=1;
        fclose(fpo);
    }
...
//////////////////////VERSION IS//////////////////////////////////////////////
    ...
    {
        sprintf(string_save_load_report[idf],"Error on whitecat_version.txt");
        b_report_error[idf]=1;
    }
    fclose(fpo);
...
////////////////////////////////////////////////////////////////////////////////
    ...
    if(specify_who_to_save_load[0]==1) ///MEMOIRES////////////////////////////////////////////////////////////
    {
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_mem_existantes);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_mem_existantes);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_memories);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_memories);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_text_mems);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_text_mems);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_text_annots);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_text_annots);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_mem_detruites);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_mem_detruites);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_mem_exclues);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_mem_exclues);
                b_report_error[idf]=1;
            }
    ...
    if(specify_who_to_save_load[1]==1) ///////////MEMOIRES TIMES///////////////////////////////////////////////
    {
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_times_mem);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_times_mem);
                b_report_error[idf]=1;
            }
    ...
    if(specify_who_to_save_load[2]==1)  ///////////MEMOIRES LINKS //////////////////////////////////////////////
    {
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_link_mem);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_link_mem);
                b_report_error[idf]=1;
            }
    ...
    if(specify_who_to_save_load[3]==1) ///////////MEMOIRES: nums de bangers affectés//////////////////////////
    {
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_banger_call_in_mem);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",  file_banger_call_in_mem);
                b_report_error[idf]=1;
            }
    ...
    if(specify_who_to_save_load[4]==1) /////////////MEMOIRES: manual ratio/////////////////////////////////////
    {
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_manual_ratio_mem);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",  file_manual_ratio_mem);
                b_report_error[idf]=1;
            }
    ...
    if(specify_who_to_save_load[5]==1)  ////////////Channels LIST//////////////////////////////////////////////
    {
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_spotlist);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",  file_spotlist);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_chan_macro_on);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",  file_chan_macro_on);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_chan_macro_reaction);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",  file_chan_macro_reaction);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_chan_macro_action);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",  file_chan_macro_action);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_chan_macro_val);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",  file_chan_macro_val);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_chview_ch);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",  file_chview_ch);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_chview_name);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",  file_chview_name);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_chview_linktype);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",  file_chview_linktype);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_chview_linkref);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",  file_chview_linkref);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_chview_view);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",  file_chview_view);
                b_report_error[idf]=1;
            }
...
//fin list
    ...
    if(specify_who_to_save_load[6]==1)  ////////////Channels Direct Chan///////////////////////////////////////
    {
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_direct_channel);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_direct_channel);
                b_report_error[idf]=1;
            }
    ...
    if(specify_who_to_save_load[7]==1)  ////////////FREEZE STATE//////////////////////////////////////////////////
    {
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_dofreeze);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_dofreeze);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_freeze_state);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_freeze_state);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_excluded_chan);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_excluded_chan);
                b_report_error[idf]=1;
            }
    ...
    if(specify_who_to_save_load[8]==1)  /////PATCH CHANNELS ////////////////////////////////////////////////////
    {
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_patch_channels);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_patch_channels);
                b_report_error[idf]=1;
            }
    ...
    if(specify_who_to_save_load[9]==1)  /////PATCH LTP / HTP////////////////////////////////////////////////////
    {
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_patch_ltp);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",file_patch_ltp);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_patch_curves);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",file_patch_curves);
                b_report_error[idf]=1;
            }
    ...
    if(specify_who_to_save_load[10]==1)  //////PATCH CURVES/////////////////////////////////////////////////////
    {
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_curve_ctrl_pt);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",file_curve_ctrl_pt);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_curve_spline_level);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",file_curve_spline_level);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_curve_matrix);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",file_curve_matrix);
                b_report_error[idf]=1;
            }
    ...
    if(specify_who_to_save_load[11]==1)  //////////////BANGER///////////////////////////////////////////////////
    {
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_bangers_names);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_bangers_names);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_bangers_types);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_bangers_types);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_bangers_actions);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_bangers_actions);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_bangers_values);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_bangers_values);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_bangers_times);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_bangers_times);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_bangers_alarms);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_bangers_alarms);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_bangers_loop);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_bangers_loop);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_bangers_looptime);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_bangers_looptime);
                b_report_error[idf]=1;
            }
    ...
    if(specify_who_to_save_load[12]==1) /////////////FADERS contents///////////////////////////////////////////
    {
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_faders_state);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_faders_state);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_dock_selected);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_dock_selected);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_dock_type);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_dock_type);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_dock_net);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_dock_net);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_dock_name);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_dock_name);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_dock_channels);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_dock_channels);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_fader_locked);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_fader_locked);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_fader_locked_full);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_fader_locked_full);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_fader_before_lock);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_fader_before_lock);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_color_to_dock);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_color_to_dock);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_fader_audio);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_fader_audio);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_chaser_to_fader);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",file_chaser_to_fader);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",  file_mem_to_dock);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",  file_mem_to_dock);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",  file_fader_fx);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",  file_fader_fx);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",  file_fader_route_fx);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",  file_fader_route_fx);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",  file_fader_fgroup);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_fader_fgroup);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",  file_fader_draw);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_fader_draw);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",  file_fader_echo);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_fader_echo);
                b_report_error[idf]=1;
            }
    ...
    if(specify_who_to_save_load[13]==1)  //Faders LFOS//////////////////////////////////////////////////////////////////
    {
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_dock_times);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",file_dock_times);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_is_for_loop_selected);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",file_is_for_loop_selected);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_lfo_speed);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",file_lfo_speed);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_lfo_mode_is);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_lfo_mode_is);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_lfo_cycle_on);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_lfo_cycle_on);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_lfo_do_next_step);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_lfo_do_next_step);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_lfo_loop_step);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_lfo_loop_step);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_fader_stoppos_levels);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_fader_stoppos_levels);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_fader_stoppos_is);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_fader_stoppos_is);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_fader_ston_is);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_fader_ston_is);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_fader_chas_autolaunch);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",file_fader_chas_autolaunch);
                b_report_error[idf]=1;
            }
...
//grid affectation
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_fader_grid_affect);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",file_fader_grid_affect);
                b_report_error[idf]=1;
            }
    ...
    if(specify_who_to_save_load[14]==1) ////////FADER CURVES///////////////////////////////////////////////////
    {
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_fader_curve);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_fader_curve);
                b_report_error[idf]=1;
            }
    ...
    if(specify_who_to_save_load[15]==1)  ///////Minifaders Presets et LOCKS Presets////////////////////////////////////
    {
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_fader_preset_selection);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_fader_preset_selection);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_lock_preset_is);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_lock_preset_is);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_lock_preset_state);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_lock_preset_state);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_lock_preset_masteris);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_lock_preset_masteris);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_lock_preset_levels);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_lock_preset_levels);
                b_report_error[idf]=1;
            }
    ...
    if(specify_who_to_save_load[16]==1) ///////////////////////////////////CHASERS//////////////////////////////
    {
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_chaser_name);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_chaser_name);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_chaser_timeunit);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_chaser_timeunit);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_chaser_stepop);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_chaser_stepop);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_chaser_play);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_chaser_play);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_chaser_loop);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_chaser_loop);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_chaser_way);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",  file_chaser_way);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",  file_chaser_allerretour);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",   file_chaser_allerretour);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_chaser_trackon);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",  file_chaser_trackon);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_chaser_tracklevel);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",  file_chaser_tracklevel);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_chaser_trackview);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_chaser_trackview);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_chaser_tracktype);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_chaser_tracktype);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_chaser_trackcontent);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",file_chaser_trackcontent);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_chaser_stepis);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",file_chaser_stepis);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_chaser_beginstep);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",file_chaser_beginstep);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_chaser_endstep);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_chaser_endstep);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_chaser_timemode);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_chaser_timemode);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_chaser_lastaffect);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",file_chaser_lastaffect);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_chaser_trrackname);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",file_chaser_trrackname);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_chaser_presets);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",file_chaser_presets);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_chaser_lchpad_pos);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",file_chaser_lchpad_pos);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_chaser_acceleroslave);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",file_chaser_acceleroslave);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_chaser_has_mem);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",file_chaser_has_mem);
                b_report_error[idf]=1;
            }
    ...
    if(specify_who_to_save_load[17]==1)  ///////MIDI AFFECTATION/////////////////////////////////////////////////////////////
    {
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_midi_affectation);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",file_midi_affectation);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_midi_send_out);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",file_midi_send_out);
                b_report_error[idf]=1;
            }
    ...
    if(specify_who_to_save_load[18]==1)  ////////////MIDI cheat midi ///////////////////////////////////////////
    {
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_midi_properties);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",file_midi_properties);
                b_report_error[idf]=1;
            }
    ...
    if(specify_who_to_save_load[19]==1)  ///////////////////TRICHRO////////////////////////////////////////////////
    {
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_dock_color_type);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_dock_color_type);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_dock_color_xy);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_dock_color_xy);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_dock_color_angle);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_dock_color_angle);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_dock_color_picker);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_dock_color_picker);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_dock_color_ch);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_dock_color_ch);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_dock_color_buffer);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_dock_color_buffer);
                b_report_error[idf]=1;
            }
    ...
    if(specify_who_to_save_load[20]==1)  //////////VIDEO TRACKING //////////////////////////////////////////////
    {
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_video_channels);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_video_channels);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_video_xy);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_video_xy);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_video_spaces_on);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_video_spaces_on);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_camera_modes);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_camera_modes);
                b_report_error[idf]=1;
            }
    ...
    if(specify_who_to_save_load[21]==1)  //ARDUINO//////////////////////////////////////////////////////////
    {
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_arduino_dig_typ);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",  file_arduino_dig_typ);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_arduino_dig_affect);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",  file_arduino_dig_affect);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_arduino_an_typ);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",  file_arduino_an_typ);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_arduino_an_aff);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_arduino_an_aff);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_arduino_dig_out);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_arduino_dig_out);
                b_report_error[idf]=1;
            }
...
//autoload autopause
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_audio_autoloadpause);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_audio_autoloadpause);
                b_report_error[idf]=1;
            }
...
//file number
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_audio_filenumber);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_audio_filenumber);
                b_report_error[idf]=1;
            }
...
//player position
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_audio_playerposition);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_audio_playerposition);
                b_report_error[idf]=1;
            }
    ...
    if(specify_who_to_save_load[23]==1)  //////////iCAT///////////////////////////////////////////////////////
    {
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_icat_nbsliders);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_icat_nbsliders);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_icat_posliders);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",  file_icat_posliders);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_icat_orsliders);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_icat_orsliders);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_icat_typsliders);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_icat_typsliders);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_icat_valsliders);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_icat_valsliders);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_icat_size_sliders);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_icat_size_sliders);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_icat_orientpage);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_icat_orientpage);
                b_report_error[idf]=1;
            }
...
//boutons
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_icat_nbbutton);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_icat_nbbutton);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_icat_pobutton);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_icat_pobutton);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_icat_size_buttons);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",file_icat_size_buttons);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_icat_typbutton);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_icat_typbutton);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_icat_actbutton);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",file_icat_actbutton);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_icat_valbutton);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_icat_valbutton);
                b_report_error[idf]=1;
            }
...
//strings
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_icat_nbstr);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_icat_nbstr);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_icat_posstr);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_icat_posstr);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_icat_sizestr);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_icat_sizestr);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_icat_typstr);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_icat_typstr);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_icat_actstr);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_icat_actstr);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_icat_valstr);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",file_icat_valstr);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_icat_nbzon);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",file_icat_nbzon);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_icat_poszon);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",file_icat_poszon);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_icat_sizezon);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",file_icat_sizezon);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_icat_typzon);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",file_icat_typzon);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_icat_valzon);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",file_icat_valzon);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_icat_posTRCKzon);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",file_icat_posTRCKzon);
                b_report_error[idf]=1;
            }
    ...
    if(specify_who_to_save_load[24]==1)  //POS WINDOWS USER/////////////////////////////////////////////////////
    {
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_pos_fenetres);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",  file_pos_fenetres);
                b_report_error[idf]=1;
            }
...
//window conf
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_windows);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",  file_windows);
                b_report_error[idf]=1;
            }
    ...
    if(specify_who_to_save_load[25]==1)  //USER COLOR PROFILE//////////////////////////////////////////////////
    {
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",  file_color_profile);
                b_report_error[idf]=1;
            }
    ...
    if(specify_who_to_save_load[26]==1)  //KBD ASCII MAPING/////////////////////////////////////////////////////
    {
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_kbd_ascii_map);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_kbd_ascii_map);
                b_report_error[idf]=1;
            }
    ...
    if(specify_who_to_save_load[27]==1)   //////////INDEXES/////////////////////////////////////////////////////
    {
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_divers_index);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",  file_divers_index);
                b_report_error[idf]=1;
            }
...
///////////////mems////////////////////////////////////////////////////////////
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_mover_mem);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_mover_mem);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_mover_mem16b);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_mover_mem16b);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_mover_numbersteps);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_mover_numbersteps);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_mover_stepis);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_mover_stepis);
                b_report_error[idf]=1;
            }
...
//valeurs_diverses[12]=allow_slider_for_sensitivity;
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_mover_divers);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_mover_divers);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_mover_spline_ratio);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_mover_spline_ratio);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_asservis_mem);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_asservis_mem);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_mover_time);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_mover_time);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_mover_autostop);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_mover_autostop);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_mover_goto);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_mover_goto);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_mover_into);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_mover_into);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_mover_params);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_mover_params);
                b_report_error[idf]=1;
            }
...
//les grilles paquées en 4 fichiers
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_grid_levels_1);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_grid_levels_1);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_grid_levels_2);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            if (fwrite(temp_grid_levels_for_save, sizeof(unsigned char), grid_levels_size, fp) != grid_levels_size)
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_grid_levels_2);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_grid_levels_3);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            if (fwrite(temp_grid_levels_for_save, sizeof(unsigned char), grid_levels_size, fp) != grid_levels_size)
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_grid_levels_3);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_grid_levels_4);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            if (fwrite(temp_grid_levels_for_save, sizeof(unsigned char), grid_levels_size, fp) != grid_levels_size)
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_grid_levels_4);
                b_report_error[idf]=1;
            }
...
//fin des 4 grid levels
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_grid_times);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_grid_times);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_grid_goto);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_grid_goto);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_grid_seekpos);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_grid_seekpos);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_grid_stoplay);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_grid_stoplay);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_grid_names);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_grid_names);
                b_report_error[idf]=1;
            }
...
//les grids players
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_gridpl_grid);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_gridpl_grid);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_gridpl_step);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_gridpl_step);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_gridpl_autost);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_gridpl_autost);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_gridpl_goto);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_gridpl_goto);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_gridpl_seekto);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_gridpl_seekto);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_gridpl_stpl);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_gridpl_stpl);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_gridpl_slave);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_gridpl_slave);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_gridpl_show);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_gridpl_show);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_gridpl_accel);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_gridpl_accel);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_gridpl_countmod);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_gridpl_countmod);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_gridpl_snapfader);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_gridpl_snapfader);
                b_report_error[idf]=1;
            }
...
//grider conf
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_grider_conf);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_grider_conf);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_gridpl_crosslv);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_gridpl_crosslv);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_grid_count);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_grid_count);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_grided_count);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_grided_count);
                b_report_error[idf]=1;
            }
...
//GRIDPLAYER 1 in MEMS
    ...
    if(specify_who_to_save_load[30]==1)
    {
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_grid_in_mems);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_grid_in_mems);
                b_report_error[idf]=1;
            }
...
//////////PLOT
    ...
    if(specify_who_to_save_load[31]==1)
    {
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_lib_sizes_symbol);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_lib_sizes_symbol);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_lib_names_symbol);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_lib_names_symbol);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_plot_angles);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_plot_angles);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_plot_positions);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_plot_positions);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_plot_nbr_symbols);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_plot_nbr_symbols);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_plot_typ);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_plot_typ);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_plot_chan);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_plot_chan);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_plot_dim);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_plot_dim);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_plot_gels);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_plot_gels);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_plot_gels_t);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_plot_gels_t);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_plot_view);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_plot_view);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_plot_options_view);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_plot_options_view);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_plot_opt_xy);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_plot_opt_xy);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_plot_shape_type);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_plot_shape_type);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_plot_shape_attr);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_plot_shape_attr);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_plot_shape_pos);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_plot_shape_pos);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_plot_shape_legend_name);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_plot_shape_legend_name);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_plot_shape_relativ_xy);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_plot_shape_relativ_xy);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_plot_shape_color_type);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_plot_shape_color_type);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_plot_shape_groups);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_plot_shape_groups);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_plot_symbols_relativgroups);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_plot_symbols_relativgroups);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_plot_symbols_notes);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_plot_symbols_notes);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_plot_legend);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_plot_legend);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_plot_symb_linked);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_plot_symb_linked);
                b_report_error[idf]=1;
            }
...
/////DRAW
    if(specify_who_to_save_load[32]==1)
    {
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_draw_presetsz);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_draw_presetsz);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_draw_levels);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_draw_levels);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_draw_chrouting);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_draw_chrouting);
                b_report_error[idf]=1;
            }
...
//ECHO
    if(specify_who_to_save_load[33]==1)
    {
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_echo_pointing_fader);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_echo_pointing_fader);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_echo_echo_mode);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_echo_echo_mode);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_echo_global_param);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_echo_global_param);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_echo_channel_man_mode);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_echo_channel_man_mode);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_echo_chan_pos);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_echo_chan_pos);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_echo_levels);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_echo_levels);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_echo_bounce);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_echo_bounce);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_echo_presets);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_echo_presets);
                b_report_error[idf]=1;
            }
...
//personnal presets
    if(specify_who_to_save_load[35]==1)
    {
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_save_preset);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_save_preset);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_save_pdf);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_save_pdf);
                b_report_error[idf]=1;
            }
...
//POUR RAFRAICHIR CORRECTEMENT LES VARIABLES DE POSITIONS DE FENETRES ( TIME WHEEL COLOR WHEEL) AVANT CALCULS
    ...
    if(specify_who_to_save_load[0]==1)//MEMOIRES/////////////////////////////////
    {
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_mem_existantes);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_memories);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",  file_text_mems);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",  file_text_annots);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_mem_detruites);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_mem_exclues);
                b_report_error[idf]=1;
            }
...
//rafraichissement potards midi
    ...
    if(specify_who_to_save_load[1]==1)///////MEMOIRES TIMES/////////////////////////
    {
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",  file_times_mem);
                b_report_error[idf]=1;
            }
    ...
    if(specify_who_to_save_load[2]==1)/////MEMOIRES LINKS///////////////////////////
    {
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",  file_link_mem);
                b_report_error[idf]=1;
            }
    ...
    if(specify_who_to_save_load[3]==1)/////MEMOIRES BANGER///////////////////////////
    {
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",  file_banger_call_in_mem);
                b_report_error[idf]=1;
            }
    ...
    if(specify_who_to_save_load[4]==1)/////MEMOIRES ratio manuel////////////////////
    {
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_manual_ratio_mem);
                b_report_error[idf]=1;
            }
    ...
    if(specify_who_to_save_load[5]==1)//channels LIST////////////////////
    {
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_spotlist);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_chan_macro_on);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_chan_macro_reaction);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_chan_macro_action);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_chan_macro_val);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_chview_ch);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_chview_name);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_chview_linktype);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_chview_linkref);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_chview_view);
                b_report_error[idf]=1;
            }
...
//Fin list
    ...
    if(specify_who_to_save_load[6]==1)/////Channels Direct Channels/////////////////
    {
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",  file_direct_channel);
                b_report_error[idf]=1;
            }
            else
            {
                sprintf(string_save_load_report[idf],"Loaded file %s", file_direct_channel);
            }
            fclose(fp);
//mise à plat d init si souci
    ...
    if(specify_who_to_save_load[7]==1)/////Channels Freeze/////////////////////////
    {
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_dofreeze);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_freeze_state);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_excluded_chan);
                b_report_error[idf]=1;
            }
    ...
    if(specify_who_to_save_load[8]==1)/////Patch circuits/////////////////////////////////
    {
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",  file_patch_channels);
                b_report_error[idf]=1;
            }
    ...
    if(specify_who_to_save_load[9]==1)/////Patch LTP-HTP/////////////////////////////////
    {
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",   file_patch_ltp);
                b_report_error[idf]=1;
            }
    ...
    if(specify_who_to_save_load[10]==1)/////Patch curves///////////////////////////
    {
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",   file_patch_curves);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",   file_curve_ctrl_pt);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",   file_curve_spline_level);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",   file_curve_matrix);
                b_report_error[idf]=1;
            }
    ...
    if(specify_who_to_save_load[11]==1)/////Banger//////////////////////////////////
    {
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_bangers_names);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_bangers_types);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_bangers_actions);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_bangers_values);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_bangers_times);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_bangers_alarms);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_bangers_loop);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_bangers_looptime);
                b_report_error[idf]=1;
            }
    ...
    if(specify_who_to_save_load[12]==1) ////FADERS CONTENT//////////////////////////
    {
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_faders_state);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_dock_selected);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_dock_type);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_dock_net);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_dock_name);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_dock_channels);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_fader_locked);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_fader_locked_full);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_fader_before_lock);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_color_to_dock);
                b_report_error[idf]=1;
            }
...
//Audio dans faders
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",  file_fader_audio);
                b_report_error[idf]=1;
            }
            else
            {
...
//
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_chaser_to_fader);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_mem_to_dock);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_fader_grid_affect);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_fader_fx);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_fader_route_fx);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_fader_fgroup);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_fader_draw);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_fader_echo);
                b_report_error[idf]=1;
            }
    ...
    if(specify_who_to_save_load[13]==1) ////FADERS LFOs//////////////////////////
    {
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",   file_dock_times);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",   file_is_for_loop_selected);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_lfo_speed);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",   file_lfo_mode_is);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",  file_lfo_cycle_on);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",file_lfo_do_next_step);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",file_lfo_loop_step);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",file_fader_stoppos_levels);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",file_fader_stoppos_is);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",file_fader_ston_is);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",file_fader_chas_autolaunch);
                b_report_error[idf]=1;
            }
    ...
    if(specify_who_to_save_load[14]==1) ////FADERS Curves/////////////////////////
    {
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",file_fader_curve);
                b_report_error[idf]=1;
            }
    ...
    if(specify_who_to_save_load[15]==1) ////FADERS Preset and LOCK PST//////////////////////////
    {
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",  file_lock_preset_is);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",  file_lock_preset_state);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",  file_lock_preset_masteris);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",  file_lock_preset_levels);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",file_fader_preset_selection);
                b_report_error[idf]=1;
            }
    ...
    if(specify_who_to_save_load[16]==1)/////////////CHASERS/////////////////////////
    {
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_chaser_name);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_chaser_timeunit);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_chaser_stepop);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_chaser_play);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_chaser_loop);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_chaser_way);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",file_chaser_allerretour);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",  file_chaser_trackon);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",  file_chaser_tracklevel);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",  file_chaser_trackview);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",  file_chaser_tracktype);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",   file_chaser_trackcontent);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",  file_chaser_stepis);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",  file_chaser_beginstep);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_chaser_endstep);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_chaser_timemode);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_chaser_lastaffect);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_chaser_trrackname);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_chaser_presets);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",  file_chaser_lchpad_pos);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",  file_chaser_acceleroslave);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",  file_chaser_has_mem);
                b_report_error[idf]=1;
            }
...
//midi_init_sepecial_case_key_on();
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",   file_midi_affectation);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",   file_midi_send_out);
                b_report_error[idf]=1;
            }
    ...
    if(specify_who_to_save_load[18]==1) /////////////MIDI cheat///////////////
    {
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",   file_midi_properties);
                b_report_error[idf]=1;
            }
    ...
    if(specify_who_to_save_load[19]==1)//////////TRICHRO////////////////////////////
    {
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_dock_color_type);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_dock_color_xy);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_dock_color_angle);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_dock_color_picker);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_dock_color_ch);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_dock_color_buffer);
                b_report_error[idf]=1;
            }
...
////////////////////////////////////////////////////////////////////////////////
    if(specify_who_to_save_load[20]==1)/////////////TRACKING VIDEO//////////////////
    {
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",  file_video_channels);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",  file_video_xy);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",  file_video_spaces_on);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",  file_camera_modes);
                b_report_error[idf]=1;
            }
...
////////////////////////////////////////////////////////////////////////////////
    ...
    if(specify_who_to_save_load[27]==1)/////////////////INDEXES/////////////////////
    {
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_divers_index);
                b_report_error[idf]=1;
            }
    ...
    if(specify_who_to_save_load[24]==1)/////POS window user////////////////////////////////////////
    {
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_pos_fenetres);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_windows);
                b_report_error[idf]=1;
            }
...
//audio autoload autopause
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_audio_autoloadpause);
                b_report_error[idf]=1;
            }
...
//audio file number
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_audio_filenumber);
                b_report_error[idf]=1;
            }
...
//position player
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_audio_playerposition);
                b_report_error[idf]=1;
            }
    ...
    if(specify_who_to_save_load[21]==1)///ARDUINO////////////////////////////////////
    {
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_arduino_dig_typ);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_arduino_dig_affect);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_arduino_an_typ);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_arduino_an_aff);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_arduino_dig_out);
                b_report_error[idf]=1;
            }
    ...
    if(specify_who_to_save_load[25]==1)  ///USER COLOR PROFILE//////////////////////////////////////////////////
    {
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error reading %s",  file_color_profile);
                b_report_error[idf]=1;
            }
            else sprintf(string_save_load_report[idf],"Loaded file %s", file_color_profile);
            fclose(fp);
    ...
    if(specify_who_to_save_load[26]==1)//////clavier ascii remaping/////////////////
    {
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_kbd_ascii_map);
                b_report_error[idf]=1;
            }
    ...
    if(specify_who_to_save_load[23]==1)////////ICAT//////////////////////////////////
    {
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_icat_nbsliders);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_icat_posliders);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_icat_orsliders);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_icat_typsliders);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_icat_valsliders);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",file_icat_size_sliders);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",file_icat_orientpage);
                b_report_error[idf]=1;
            }
...
//buttons
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",file_icat_nbbutton);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",file_icat_pobutton);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",file_icat_size_buttons);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",file_icat_typbutton);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",file_icat_actbutton);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",file_icat_valbutton);
                b_report_error[idf]=1;
            }
...
//strings
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",file_icat_nbstr);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",file_icat_posstr);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",file_icat_sizestr);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",file_icat_typstr);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",file_icat_actstr);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",file_icat_valstr);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",file_icat_nbzon);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",file_icat_poszon);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",file_icat_sizezon);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",file_icat_typzon);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",file_icat_valzon);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",file_icat_posTRCKzon);
                b_report_error[idf]=1;
            }
    ...
    if(specify_who_to_save_load[28]==1) //////////MOVER//////////////////////////////
    {
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",  file_mover_mem);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",  file_mover_mem16b);
                b_report_error[idf]=1;
            }
...
//nb steps
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_mover_numbersteps);
                b_report_error[idf]=1;
            }
...
//actual step is
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_mover_stepis);
                b_report_error[idf]=1;
            }
...
//divers
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_mover_divers);
                b_report_error[idf]=1;
            }
...
//ratio spline
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_mover_spline_ratio);
                b_report_error[idf]=1;
            }
...
//iris flous divers parametres asservis
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_asservis_mem);
                b_report_error[idf]=1;
            }
...
//times
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_mover_time);
                b_report_error[idf]=1;
            }
...
//autostop
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_mover_autostop);
                b_report_error[idf]=1;
            }
...
//gotos
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_mover_goto);
                b_report_error[idf]=1;
            }
...
//intos
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_mover_into);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_mover_params);
                b_report_error[idf]=1;
            }
...
////////////GRID////////////////////////////////////////////////////////////////
    if(specify_who_to_save_load[29]==1)
    {
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_grid_levels_1);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            if (fread(temp_grid_levels_for_save, sizeof(unsigned char), grid_levels_size, fp) !=grid_levels_size)
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_grid_levels_2);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            if (fread(temp_grid_levels_for_save, sizeof(unsigned char), grid_levels_size, fp) !=grid_levels_size)
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_grid_levels_3);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            if (fread(temp_grid_levels_for_save, sizeof(unsigned char), grid_levels_size, fp) !=grid_levels_size)
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_grid_levels_4);
                b_report_error[idf]=1;
            }
...
//fin du groupedes grids levels
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_grid_times);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_grid_goto);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_grid_seekpos);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_grid_stoplay);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_grid_names);
                b_report_error[idf]=1;
            }
...
//les grids players
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_gridpl_grid);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_gridpl_step);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_gridpl_autost);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_gridpl_goto);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_gridpl_seekto);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_gridpl_stpl);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_gridpl_slave);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_gridpl_show);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_gridpl_accel);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_gridpl_countmod);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_gridpl_snapfader);
                b_report_error[idf]=1;
            }
...
//grider conf
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_grider_conf);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_gridpl_crosslv);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_grid_count);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_grided_count);
                b_report_error[idf]=1;
            }
...
//GRIDPLAYER 1 in MEMS
    if(specify_who_to_save_load[30]==1)
    {
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_grid_in_mems);
                b_report_error[idf]=1;
            }
...
//personnal save preset
    if(specify_who_to_save_load[35]==1)
    {
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_save_preset);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_save_pdf);
                b_report_error[idf]=1;
            }
...
//DRAW
    if(specify_who_to_save_load[32]==1)
    {
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_draw_presetsz);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_draw_levels);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_draw_chrouting);
                b_report_error[idf]=1;
            }
...
//ECHO
    if(specify_who_to_save_load[33]==1)
    {
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_echo_pointing_fader);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_echo_echo_mode);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_echo_global_param);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_echo_channel_man_mode);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_echo_chan_pos);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_echo_levels);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_echo_bounce);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_echo_presets);
                b_report_error[idf]=1;
            }
...
//////LIGHTING PLOT en dernier because repertoires
    if(specify_who_to_save_load[31]==1)
    {
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_lib_sizes_symbol);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_lib_names_symbol);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_plot_angles);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_plot_positions);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_plot_nbr_symbols);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_plot_typ);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_plot_chan);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_plot_dim);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_plot_gels);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_plot_gels_t);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_plot_view);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_plot_options_view);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_plot_opt_xy);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_plot_shape_type);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_plot_shape_attr);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_plot_shape_pos);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_plot_shape_legend_name);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_plot_shape_relativ_xy);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_plot_shape_color_type);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_plot_shape_groups);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_plot_symbols_relativgroups);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_plot_symbols_notes);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_plot_legend);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_plot_symb_linked);
                b_report_error[idf]=1;
            }
            else sprintf(string_save_load_report[idf],"Loaded file %s", file_plot_legend);
            fclose(fp);
