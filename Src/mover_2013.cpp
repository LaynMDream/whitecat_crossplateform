...
if(window_focus_id==W_MOVER && mouse_x> xt+180-10 && mouse_x< xt+180+255+10 && mouse_y>=yt+5+(dv*15) && mouse_y<yt+5+(dv*15)+10 && mouseClicLeft.isDown())
{
...
if(window_focus_id==W_MOVER && mouse_x>xt+445 && mouse_x<xt+445+10 && mouse_y>yt+5+(dv*15) && mouse_y<yt+5+(dv*15)+10 && mouseClicLeft.isDown() && mouseClicLeft.isToBeProcessed())
{
...
{
if(mouseClicLeft.isDown()  && index_mouse_is_tracking==0 && mouseClicLeft.isToBeProcessed() )
{
index_copy_params=toggle(index_copy_params); mouseClicLeft.SetProcessed();
}
}
...
{
if(mouseClicLeft.isDown()  && index_mouse_is_tracking==0 )
{
...
{
if(mouseClicLeft.isDown() && mouseClicLeft.isToBeProcessed() && index_mouse_is_tracking==0 )
{
switch(lopt)
{
case 0:
...
if(mouseClicLeft.isDown()  && mouseClicLeft.isToBeProcessed() && index_mouse_is_tracking==0 )
{
index_spline=toggle(index_spline);mouseClicLeft.SetProcessed();
}
}
...
if(window_focus_id==W_MOVER && mouse_x>x_track+310 && mouse_x<x_track+310+150 && mouse_y>y_track+250 && mouse_y<y_track+250+25 && mouseClicLeft.isDown() && mouseClicLeft.isToBeProcessed())
{
...
if(window_focus_id==W_MOVER && mouse_x>track_aera_x+20 && mouse_x< track_aera_x+80 && mouse_y>track_aera_y+380 && mouse_y<track_aera_y+405)
{
 if(mouseClicLeft.isDown()  && mouseClicLeft.isToBeProcessed() && index_mouse_is_tracking==0 )
 {
 tracker_mode=toggle(tracker_mode);   mouseClicLeft.SetProcessed();
 }
}
if (tracker_mode==0)
{
...
if(window_focus_id==W_MOVER && mouse_x>track_aera_x+20 && mouse_x< track_aera_x+80 && mouse_y>track_aera_y+415 && mouse_y<track_aera_y+440)
{
 ...
 if(mouseClicLeft.isDown() && mouseClicLeft.isToBeProcessed()  && index_mouse_is_tracking==0 && tracker_mode==1)
 {
tracker_16b_edit=toggle(tracker_16b_edit);mouseClicLeft.SetProcessed();
 }
}
...
if(mouseClicLeft.isDown() && mouseClicLeft.isToBeProcessed() && index_mouse_is_tracking==0 )
{
lockX_on=toggle(lockX_on);mouseClicLeft.SetProcessed();
}
}
...
if(mouseClicLeft.isDown() && mouseClicLeft.isToBeProcessed() && index_mouse_is_tracking==0 )
{
lockY_on=toggle(lockY_on);mouseClicLeft.SetProcessed();
}
}
}
...
if(mouseClicLeft.isDown() && mouseClicLeft.isToBeProcessed() && index_mouse_is_tracking==0 )
{
invX_on=toggle(invX_on);mouseClicLeft.SetProcessed();
}
}
if(mouse_x>track_aera_x+100 && mouse_x<track_aera_x+160)
{
if(mouseClicLeft.isDown() && mouseClicLeft.isToBeProcessed() && index_mouse_is_tracking==0 )
{
invY_on=toggle(invY_on);mouseClicLeft.SetProcessed();
}
}
}
...
{
if(mouseClicLeft.isDown()  && index_do_dock==1 &&  mouseClicLeft.isToBeProcessed() && index_mouse_is_tracking==0 )
{
