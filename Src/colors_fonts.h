...
* \file color_fonts.h
* \brief {header file for a few global variables in whitecat}
...
*   Header qui contient quelques variables globales déclarées dans whitecat
*
*   Header for a few global variables used in whitecat
*
*/
