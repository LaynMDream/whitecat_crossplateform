...
int DoReportChaserTrack(int numchaser, int numtrack)
{
    for (int u=1; u<514; u++)
    {
        ...
        if(bufferFaders[u]>TrackContains[numchaser][numtrack][u])
        {
            TrackContains[numchaser][numtrack][u]=bufferFaders[u];
        }
    }
    for (int x=1; x<514; x++)
    {
...
////////TRACK LEVEL////////////////////////////////////////////////////////////////
    ...
    if(mouse_x>=xp+30 && mouse_x<=xp+30+127 && mouse_y>yp && mouse_y<yp+10)
    {
        ...
        else
        {
            ...
            if(track_level[chaser_selected][num_track]<0)
            {
                track_level[chaser_selected][num_track]=0;
            }
            if(track_level[chaser_selected][num_track]>127)
            {
                track_level[chaser_selected][num_track]=127;
            }
            midi_levels[1023+num_track]=track_level[chaser_selected][num_track];
...
//play
    if(mouse_x>xcha+10 && mouse_x<xcha+10+20 && mouse_y>ycha+50 && mouse_y<ycha+50+20  && mouseClicLeft.isToBeProcessed())
    {
...
//seek to begin
    if(mouse_x>xcha+40 && mouse_x<xcha+40+20 && mouse_y>ycha+50 && mouse_y<ycha+50+20  && mouseClicLeft.isDown() && mouseClicLeft.isToBeProcessed())
    {
...
//loop
    if(mouse_x>xcha+70 && mouse_x<xcha+70+20 && mouse_y>ycha+50 && mouse_y<ycha+50+20  && mouseClicLeft.isDown() && mouseClicLeft.isToBeProcessed())
    {
...
//forward sens
    if(mouse_x>xcha+110 && mouse_x<xcha+110+20 && mouse_y>ycha+50 && mouse_y<ycha+50+20 && mouseClicLeft.isToBeProcessed())
    {
...
//backward sens
    if(mouse_x>xcha+140 && mouse_x<xcha+140+20 && mouse_y>ycha+50 && mouse_y<ycha+50+20&& mouseClicLeft.isToBeProcessed())
    {
...
//backward and forward sens
    if(mouse_x>xcha+170 && mouse_x<xcha+170+20 && mouse_y>ycha+50 && mouse_y<ycha+50+20 && mouseClicLeft.isToBeProcessed())
    {
...
////AFFECT TO DOCK
    if(mouse_x>xcha+430 && mouse_x<xcha+430+110 && mouse_y>ycha+80 && mouse_y<ycha+80+20  && mouseClicLeft.isToBeProcessed())
    {
...
//refresh midi
    ...
    if(mouse_x>xcha+520 && mouse_x<xcha+520+40 && mouse_y>ycha+50 && mouse_y<ycha+50+20 && mouseClicLeft.isToBeProcessed())
    {
        ...
        if(autolaunch[cmptfader]==1   )
        {
            ...
            if(( Fader[cmptfader]!=Fader_previous[cmptfader]) || ( previous_dock_used[cmptfader]!=dock_used_by_fader_is[cmptfader] ) )
            {
                ...
                case 11://chasers
                    ...
                    if  (Fader[cmptfader]==0)
                    {
                        chaser_is_playing[the_chaser]=0;
                    ...
                    {
                        chaser_is_playing[the_chaser]=1;
                    }
                    break;
                case 12://gridplayer
                    ...
                    if((Fader_previous[cmptfader]==0 && Fader[cmptfader]>0 )|| ( previous_dock_used[cmptfader]!=dock_used_by_fader_is[cmptfader] ))
                    {
                        grider_is_playing[the_grid_player]=1;
